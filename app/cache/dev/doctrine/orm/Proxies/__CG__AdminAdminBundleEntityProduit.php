...
class Produit extends \Admin\AdminBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Produit' . "\0" . 'nom', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Produit' . "\0" . 'description', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Produit' . "\0" . 'quantite');
        }
