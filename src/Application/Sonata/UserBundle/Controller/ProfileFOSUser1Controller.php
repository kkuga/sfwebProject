...
class ProfileFOSUser1Controller extends Controller
{
    ...
    public function showAction()
    {
        ...
        if (!is_object($user) || !$user instanceof UserInterface) {
            throw new AccessDeniedException('This DDDD user does not have access to this section.');
        }
    ...
    public function editProfileAction()
    {
        $user = $this->container->get('security.context')->getToken()->getUser();
        if (!is_object($user) || !$user instanceof UserInterface) {
            throw new AccessDeniedException('6666This user does not have access to this section.');
        }
